import type { User, AnalystStat, OverviewStats, MonthlyLprEntry, AgencyEntry, DailyAlertEntry } from '../types'

export const users: User[] = [
  { id: 0, username: 'admin', name: 'Administrator', role: 'admin' },
  { id: 1, username: 'Maria Santos', name: 'Maria Santos', role: 'analyst' },
  { id: 2, username: 'James Rivera', name: 'James Rivera', role: 'analyst' },
...
export const credentials: Record<string, string> = {
  admin: 'SecureCity2026',
  'Maria Santos': 'analyst01',
  'James Rivera': 'analyst02',
...
export const analystStats: AnalystStat[] = [
...
export const monthlyLprByAnalyst: MonthlyLprEntry[] = [
...
export const agencyBreakdown: AgencyEntry[] = [
...
export const dailyAlerts: DailyAlertEntry[] = [
...
export const CHART_COLORS: string[] = ['#00d4ff', '#4f8ef7', '#9b5cf6', '#f76e8e', '#ffb648', '#3ddc97']
